...
module createCono()
{
 difference()
 {
   ...
   cylinder (r1=tuboRadio, r2=roscaDiam-roscaPared, h=roscaH+9, $fn=100);
   ...
   cylinder(r=roscaDiam-roscaPared+2,roscaH+0.3);
...
huyoMasPared(roscaDiam-1,roscaPared,0.75,center=true);
translate([0,0,3])
